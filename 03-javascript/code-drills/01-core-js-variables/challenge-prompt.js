...
// Create a variable `profession` and assign it a value of a string, "Computer Programmer".
    var profesion = "Computer Programmer"
...
var statementOne = subject + " : " + fullName + " is a " + nationality + " " + profesion + " born in " + birthYear;
...
// var statmentTwo = "She is commonly reffered to as the first computer programmer"
// Use the `knownFor` variable instead of hard coding in the full string
// much like you did for the console logs and `fullName`
var statementTwo = "She is commonly reffered to as the " + knownFor
