...
var wantsBoba = window.confirm("Welcome to the Boba Tea Shop!  Would you like a Boba?")
...
if (wantsBoba === true) {
    ...
    var drinkFlavor = prompt("Which flavor?")
...
document.write("Your " + drinkFlavor + " boba teas will be ready soon")}
