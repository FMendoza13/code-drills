...
var characterOneAge = "35 years old";
...
var chararacterOneYearlyRent = characterOneRent * 12

// make a variable called `characterOneYearlyExpenses` and assign it to be 12 times `characterOneExpenses`
var chararacterOneYearlyExpenses = characterOneExpenses * 12
...
var characterOneYearlySavings = characterOneSalary - (chararacterOneYearlyExpenses + chararacterOneYearlyRent)
...
// Create an if statement to check if `characterOneYearlySavings` is greater than `characterTwoYearlySavings`
        if (characterOneYearlySavings > characterTwoYearlyExpenses) {
